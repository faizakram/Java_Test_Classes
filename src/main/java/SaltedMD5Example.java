...
public class SaltedMD5Example {
	public static void main(String[] args) throws NoSuchAlgorithmException, NoSuchProviderException {
		...
		String regeneratedPassowrdToVerify1 = getSecurePassword(passwordToHash, salt);
		System.out.println(regeneratedPassowrdToVerify1); // Prints 83ee5baeea20b6c21635e4ea67847f66
	}
